...
def import_without_capstone():
    ...
    with mock.patch("builtins.__import__", side_effect=reject_capstone):
        yield importlib.import_module("tools.find_thumb_calls")


class FindThumbCallsTests(unittest.TestCase):
    def test_import_does_not_require_capstone(self):
        with import_without_capstone() as module:
        ...
        with tempfile.TemporaryDirectory() as temp_dir:
            ...
            with import_without_capstone() as module:
                self.assertEqual(
                    ...
                    [
                        (ROM_BASE, "bl", "#0x800000e"),
                        (ROM_BASE + 4, "b", "#0x800000e"),
                    ],
                )
    ...
    def test_cli_parses_bounds_and_preserves_output_headers(self):
        ...
        with import_without_capstone() as module:
            with (
                ...
                mock.patch.object(
                    module,
                    "scan_calls",
                    return_value=[(ROM_BASE + 4, "b", "#0x800000e")],
                ) as scan_calls,
        ...
        self.assertIn("0x08000004: b    #0x800000e", rendered)
