...
class MapM4AInstrumentTests(unittest.TestCase):
    ...
    def test_all_executed_notes_have_terminal_instruments(self):
        ...
        self.assertEqual(result["directsound_wave_type_counts"], {"0x0000": 16169})
        self.assertEqual(result["directsound_nonloop_note_count"], 8442)
        self.assertEqual(result["directsound_loop_note_count"], 7727)
        self.assertEqual(result["song_reverb_counts"], {"0": 58, "128": 22})
