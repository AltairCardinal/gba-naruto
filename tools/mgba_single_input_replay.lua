...
local keys = { Down = C.GBA_KEY.DOWN, A = C.GBA_KEY.A, B = C.GBA_KEY.B, L = C.GBA_KEY.L, Up = C.GBA_KEY.UP }
local key = assert(keys[key_name], "input key must be Down, A, B, L, or Up")
local frame = 0
