...
生成时间：`2026-07-12T14:57:45.667017+00:00`
...
- `documentation`：`32` / `32`。
- `rom_fidelity`：`32` / `32`。
- verification 分布：`code_verified`=2, `disproved`=5, `runtime_verified`=8, `static_verified`=17。
...
| `maps` | ✅ `0x53D910` | ✅ | ✅ (47) | ✅ `static_verified` | ✅ (34) | ✅ (423) | ✅ | — |
