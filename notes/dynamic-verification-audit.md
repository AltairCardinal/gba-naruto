...
| 8 | data-table-a (historical slug; real base `0x5A143C`) | code | 46 profile/character description text pointers. Two consumers index ID×4; one loop explicitly bounds IDs at 45. Old base was physical entry 26. |
...
| 18 | menu-ui (historical slug; real base `0x5A4DEC`) | code | `0x08096138` computes record ID×40 + variant×8 for variants 0..4 and uses special pair `0x5A4DE4` for variant 5. Complete 63×5 matrix; old bank was records 61–62. |
